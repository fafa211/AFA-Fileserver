$(function () {
    ...
    //图表数据接入
    var echart = new Echarts('#main', 'line', G_BASE_URL + '/manage/ajax/statistic/?tag=new_user,user_valid&start_date=' + dateArr[3] + '&end_date=' + dateArr[2]);
    var echart2 = new Echarts('#main2', 'line', G_BASE_URL + '/manage/ajax/statistic/?tag=new_question,new_answer,new_topic,new_favorite_item,new_question_redirect&start_date=' + dateArr[3] + '&end_date=' + dateArr[2]);
    var echart3 = new Echarts('#main3', 'line', G_BASE_URL + '/manage/ajax/statistic/?tag=new_answer_vote,new_answer_thanks,new_question_thanks&start_date=' + dateArr[3] + '&end_date=' + dateArr[2]);
