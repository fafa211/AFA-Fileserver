...
<input type="password" name="passwd" class="form-control" id="inputpasswd" placeholder="密码" value="" required pattern="[0-9a-zA-z]{6,20}" title="密码必须为数字或字母，长度为6-20位">
</div>
<div class="form-group">
<label name="bindip" for="inputbindip" class="control-label">绑定服务器IP</label>
<input type="text" name="bindip" class="form-control" id="inputbindip" placeholder="绑定服务器IP" value="">
</div>
